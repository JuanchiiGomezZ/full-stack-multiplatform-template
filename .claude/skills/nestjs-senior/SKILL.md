---
name: nestjs-senior
description: Use when implementing backend features in NestJS 11 with Prisma 5, including creating endpoints, adding database fields, implementing authentication, or optimizing existing code. Requires deep knowledge of the project's layered architecture, Zod validation patterns, soft delete conventions, and multi-tenancy implementation.
---
